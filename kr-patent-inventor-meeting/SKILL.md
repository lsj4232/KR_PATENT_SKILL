...
- (2026-05-27, 사건 A) IDS 검토 시 청구항 카테고리 4종(방법·시스템·장치·프로그램/매체) 확보 가능성 우선 질문. 방법 청구항만으로 들어온 IDS는 권리범위 부족으로 직결 — 시스템 메모리·프로세서, 프로그램·기록매체 청구항 신설 의사를 발명자 미팅에서 미리 확인.
- (2026-05-28, 사건 D) 영문 학술 논문(예: DGFNet 류) 원본이 IDS로 제공된 경우, 영문 약어와 한국어 청구항 용어 사이의 1:1 매핑표 도출을 발명자 미팅 질문 리스트에 별도 항목으로 포함 — 본문 작성 전 단계에서 발명자에게 한국어 명명 의도 확인.
