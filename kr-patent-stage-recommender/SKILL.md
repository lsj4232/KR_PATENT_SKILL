...
- (2026-05-27, P-2026-011-01-KR 첫 사용) 시그널 ④(자체 사전 정의 단락) 검출은 표준 4단 템플릿("라 함은 ~ 의미할 수 있다") 외 변형 형식도 인정 필수. 변형 패턴: "본 명세서에서 ~ 정의될 수 있다", "본 발명에서 ~ 명명될 수 있다", "라고 함은 ~ 의미할 수 있다", "~ 라 함은 ~ 이해될 수 있다". 표준 템플릿만 검색하면 정의 적용된 명세서를 "미적용"으로 오진.
